...
public class Helper : MonoBehaviour
{
    ...
    [SerializeField] private float howFloatSpeed = 0.2f;

    // 操作方法を表示
    public void HowDisplay()
    {
        float x = how.position.x;
        how.position = new Vector3(Screen.width + 200f, how.position.y, 0f);
        how.gameObject.SetActive(true);
        how.DOMoveX(x, howFloatSpeed);
    }
